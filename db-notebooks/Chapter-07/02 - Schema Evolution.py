...
# MAGIC       * 
# MAGIC   FROM
# MAGIC       delta.`/mnt/datalake/book/chapter07/TaxiRateCode`
# MAGIC ORDER BY
# MAGIC     RateCodeId
...
# MAGIC %sh
# MAGIC grep "metadata" /dbfs/mnt/datalake/book/chapter07/TaxiRateCode/_delta_log/00000000000000000003.json > /tmp/commit.json
...
# MAGIC cat /dbfs/mnt/datalake/book/chapter07/TaxiRateCode/_delta_log/00000000000000000004.json
# MAGIC
# MAGIC
...
# MAGIC ls -al /dbfs/mnt/datalake/book/chapter07/TaxiRateCode/_delta_log 
...
# MAGIC cat /dbfs/mnt/datalake/book/chapter07/TaxiRateCode/_delta_log/00000000000000000000.json
# MAGIC
# MAGIC
...
# MAGIC grep "metadata" /dbfs/mnt/datalake/book/chapter07/TaxiRateCode/_delta_log/00000000000000000002.json > /tmp/commit.json
# MAGIC python -m json.tool < /tmp/commit.json
